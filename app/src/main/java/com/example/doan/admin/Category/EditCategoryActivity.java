...
public class EditCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<CategoryModel> category = databaseHelper.getCategory(null,-1,categoryID);
        try {
            String text = String.valueOf(category.get(0).getCategoryName());
        ...
        if (category != null) {
            ...
            for (String field : fields) {
                ...
                editText.setText(getValueForField(category.get(0), field));
            ...
            btnSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    boolean success = databaseHelper.updateCategory(categoryID, editTextValues.get(1),
                            editTextValues.get(2));
                    if (success)
                        Toast.makeText(EditCategoryActivity.this, "Success!", Toast.LENGTH_SHORT).show();
                    else
                        Toast.makeText(EditCategoryActivity.this, editTextValues.get(1), Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private String getValueForField(CategoryModel category, String field) {
        //
